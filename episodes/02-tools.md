...
4. Your username
5 and 6. In this course we are using Python 3. If `python --version` gives you Python 2.x you may have two bversions of Python installed on your computer and need to be careful which one you are using.
