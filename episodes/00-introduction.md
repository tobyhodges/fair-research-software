...
consistently produce the same answer. (For example, I drop my pen 10 times and each time it falls to the floor.)
...
same research question and a qualitatively similar or identical answer is produced. (I lend you my pen and you drop it out the window, it still falls to the floor.)
* **Generalisable research**: combining replicable and robust findings allow us to form generalisable results 
that are broadly applicable to different types of data or contexts. (Everything we drop falls, therefore gravity exists.)
